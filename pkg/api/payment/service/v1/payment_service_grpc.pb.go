...
const (
	PaymentService_Create_FullMethodName = "/payment.service.v1.PaymentService/Create"
	PaymentService_Get_FullMethodName    = "/payment.service.v1.PaymentService/Get"
	PaymentService_List_FullMethodName   = "/payment.service.v1.PaymentService/List"
)
...
func (c *paymentServiceClient) Create(ctx context.Context, in *requests.CreateRequest, opts ...grpc.CallOption) (*responses.CreateResponse, error) {
...
func (c *paymentServiceClient) Get(ctx context.Context, in *requests.GetRequest, opts ...grpc.CallOption) (*responses.GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) List(ctx context.Context, in *requests.ListRequest, opts ...grpc.CallOption) (*responses.ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPaymentServiceServer) Create(context.Context, *requests.CreateRequest) (*responses.CreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedPaymentServiceServer) Get(context.Context, *requests.GetRequest) (*responses.GetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedPaymentServiceServer) List(context.Context, *requests.ListRequest) (*responses.ListResponse, error) {
...
func _PaymentService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Create(ctx, req.(*requests.CreateRequest))
	}
...
func _PaymentService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Get(ctx, req.(*requests.GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).List(ctx, req.(*requests.ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "payment/service/v1/payment_service.proto",
}
